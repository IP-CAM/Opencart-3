...
class ModelExtensionPaymentSgopayment extends Model {
	...
	public function install (){
		...
		$sqlinsertsetting = "INSERT INTO `".DB_PREFIX."setting` (`store_id`, `code`, `key`, `value`, `serialized`) values ('0','transaction_fee','transaction_fee_status','1','0')";
		$this->db->query($sqlinsertsetting);
		
		$sqlinsertsetting2 = "INSERT INTO `".DB_PREFIX."setting` (`store_id`, `code`, `key`, `value`, `serialized`) values ('0','transaction_fee','transaction_fee_sort_order','1','0')";
	...
	public function uninstall (){		
		...
		$sqldeletesetting = "DELETE FROM `".DB_PREFIX."setting` where `code` = 'transaction_fee' ";
